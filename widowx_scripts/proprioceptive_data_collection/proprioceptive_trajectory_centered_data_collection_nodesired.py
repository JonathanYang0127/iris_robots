...
DATA_PATHS = [
    ...
    '/iris/u/jyang27/dev/iris_robots/widowx_scripts/proprioceptive_data_collection/proprioceptive_data_tc_nodesired_new/combined_trajectories.npy'
]
traj = []
...
for i in range(200):
    ...
    #plt.clf()
    ax.quiver(X[1::10], Y[1::10], Z[1::10], U3[1::10], V3[1::10], W3[1::10], color='green')
    #plt.show()
    plt.savefig('images/plot2d_cdp_model.png')
    '''
